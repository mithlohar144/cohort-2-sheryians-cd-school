...
` +
    ...
    do {
      if (n === 0) {
        ...
        t: {
          ...
          Wr(a, e, nl, qu, Pc, l, gl, Fe, Ra, ge, u, null, -0, 0);
        }
      }
      break;
    } while (!0);
  ...
  function Wr(t, l, e, a, n, u, i, o, m, E, R, C, T, A) {
    if (
      ((t.timeoutHandle = -1),
      (C = l.subtreeFlags),
      ...
      ((C = {
        ...
        Gr(l, u, C));
      var L =
        (u & 62914560) === u ? Hu - ol() : (u & 4194048) === u ? Kr - ol() : 0;
      if (((L = f0(C, L)), L !== null)) {
        ((ae = u),
          (t.cancelPendingCommit = L(
            ad.bind(null, t, l, u, e, a, n, i, o, m, R, C, null, T, A),
          )),
          Te(t, u, i, !E));
        return;
      }
...
function di(c, s, r) {
  ...
  function N(B, X, j) {
    ...
    return Vf(B) ? !0 : (s.append(rm(j, X, h), g(B)), !1);
  }
  const H = [],
    V = Object.assign(yv, {
      defaultVisitor: N,
...
function Iv(c, s) {
  ...
  for (let S = 0; S < r; S++) {
    ...
    if (
      ((d = f),
      !kv(f) && ((d = kf[(z = String(f)).toLowerCase()]), d === void 0))
    )
  ...
  a1 = () => {
    ...
    function r() {
      At.get("http://localhost:3000/api/notes").then((h) => {
        (console.log(h.data.note), s(h.data.note));
      });
    }
    Qf.useEffect(() => {
      r();
    ...
    function f(h) {
      h.preventDefault();
      const { title: S, descripation: z } = h.target.elements;
      (console.log(S.value, z.value),
        At.post("http://localhost:3000/api/notes", {
          title: S.value,
          descripation: z.value,
        }).then((M) => {
        ...
        pl.jsxs("form", {
          ...
          children: [
            ...
            pl.jsx("input", {
              name: "descripation",
              type: "text",
              placeholder: "Enter Decripation",
            }),
            pl.jsx("button", { children: "create Node" }),
          ],
        }),
        pl.jsx("div", {
          className: "notes",
            ...
            pl.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  pl.jsx("p", { children: h.descripation }),
                  pl.jsx("button", {
                    onClick: () => {
                      d(h._id);
                    },
